			...
			<div class="container d-flex justify-content-between">
				...
				<div class="row">
					...
					<div class="form-group col-4">
						...
						<input type="number" class="form-control <?php if(isset($_COOKIE['dark'])) echo 'input-dark'; ?>" value="<?php echo $players; ?>" min="2" max="256" onchange="location.href='test_view_brackets_double.php?players='+this.value;">
					</div>

					<div class="form-group col-6">
						<label >Cantidad</label>
						<input type="range" class="form-control-range" value="<?php echo $players; ?>" min="2" max="256" onchange="location.href='test_view_brackets_double.php?players='+this.value;">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			...
			<div id="bracket-container" class="col-lg-12 overflow-auto bracket-container<?php echo $dark;?>">
				<div>
					<svg width="<?php echo count($tournament->getRounds()) * 100 + 15; ?>" height="<?php echo $tournament->getMaxValues()['matches'] * 140 + 150; ?>">
						<?php
